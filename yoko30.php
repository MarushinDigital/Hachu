...
$html = <<< EOF
    <div
        style="width: 200px;padding-left: 15px;text-align: center;font-size: 24pt;font-weight: bold;display:flex;border: 2px solid #000;">
        定番発注書</div>
    ...
    <div style="text-align: left;width: 90%; margin: 20px 20px;">
        <table border="1" cellpadding="0" cellspacing="0">
            <tbody>
                <tr>
                    <td width="175" class="hd">発注先</td>
                    <td width="100">80214</td>
                    <td width="550" style="text-align: left;padding-left: 5px;">孚日家紡有限公司</td>
                    <td width="175" class="hd">発注日</td>
                    <td width="120">2023-04-28</td>
                    <td width="175" class="hd">発注者</td>
                    <td width="175">増田　汐里</td>
                    <td width="175" class="hd">入力者</td>
                    <td width="175">増田　汐里</td>
                </tr>
            </tbody>
        </table>
        <table border="1" cellpadding="0" cellspacing="0">
            <tbody>
                <tr>
                    <td width="175" class="hd">代表納期</td>
                    <td width="120">2023-04-29</td>
                    <td width="175" class="hd">新規・追加区分</td>
                    <td width="100">新規</td>
                    <td width="175" class="hd">契約書No</td>
                    <td width="140">1234567890</td>
                </tr>
    ...
    <div style="text-align: left;">
        <table border="1" cellpadding="0" cellspacing="0">
            <tbody>
                <tr>
                    <th width="20">No</th>
                    <th width="155">商品コード</th>
                    <th width="175">品番</th>
                    <th width="350">品名</th>
                    <th width="175">JANコード</th>
                    <th width="700">色</th>
                    <th width="175">C/S</th>
                    <th width="175">数量</th>
                    <th width="175">単価 (円)</th>
                    <th width="175">＄単価</th>
                    <th width="175">為替</th>
                    <th width="175">経費率</th>
                    <th class="lg" width="175">ロイヤリティ</th>
                    <th width="175">上代</th>
                </tr>
                <tr>
                    <td>1</td>
